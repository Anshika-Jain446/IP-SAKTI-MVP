...
from data.tk.ip_sakti_tk_pipeline.backend.retriever import (
    search_tk,
)
...
def normalize_tk_result(
    ...
    canonical_matches = (
        find_canonical_ingredient_matches(
            ingredients,
            text,
        )
    )
